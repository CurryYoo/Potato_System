...
import com.example.kerne.potato.temporarystorage.InfoItemBar;
...
//        InfoItemBar mbar_height = new InfoItemBar(TestActivity.this, "十株株高");
...
//        InfoItemBar mbar_branch = new InfoItemBar(TestActivity.this, "十株分支数");
//        mbar_branch.addView(view_branch);
//        mbar_branch.setShow(true);
//        mLinearLayout.addView(mbar_branch);
//        View view_big = LayoutInflater.from(TestActivity.this).inflate(R.layout.item_big, null);
...
//        View view_small = LayoutInflater.from(TestActivity.this).inflate(R.layout.item_small, null);
