...
public class FieldClickAdapter extends RecyclerView.Adapter<FieldClickAdapter.RcvClickViewHolder> {

    private static final String TAG = FieldClickAdapter.class.getSimpleName();
